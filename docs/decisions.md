...
- [ ] **VC12** **AI disclosure is a toggle**, not a hardcoded behaviour. Local recording law
...
- [ ] **VC18** The three existing agent YAMLs (`sample-realtime`, `supplier-caller` and one
      more worked example) are **deleted, not migrated** - why: they were worked examples written to
