...
and flags it. **Australia/Perth observes no daylight saving**, so never test this against a
zone without DST alone - `tests/test_schedule_time.py` uses Sydney and London and says why.
